					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">게임소식 <b class="caret"></b></a>
									<ul class="dropdown-menu multi-column columns-3">
										<li>
											<div class="col-sm-4">
												<ul class="multi-column-dropdown">
													<li><a href="genre.html">신규 게임</a></li>
												</ul>
											</div>
											<div class="col-sm-4">
												<ul class="multi-column-dropdown">
													<li><a href="genre.html">최신 법률</a></li>
												</ul>
											</div>
		...
		<div class="w3_agilits_inner_bottom">
			<div class="col-md-6 wthree_agile_login">
				<ul>
					...
					<li><a href="#" class="login" data-toggle="modal" data-target="#myModal4">로그인</a></li>
