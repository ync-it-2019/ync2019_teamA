...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
  ...
  <!-- Style-sheets -->
  <!-- Bootstrap Css -->
  <link href="/resources/css/bootstrap-mp.css" rel="stylesheet" type="text/css" media="all" />
  <!-- Bootstrap Css -->
  <!-- Bars Css -->
  <link rel="stylesheet" href="/resources/css/bar-mp.css">
  <!--// Bars Css -->
  <!-- Calender Css -->
  <link rel="stylesheet" type="text/css" href="/resources/css/pignose.calender-mp.css" />
  <!--// Calender Css -->
  <!-- Common Css -->
  <link href="/resources/css/style-mp.css" rel="stylesheet" type="text/css" media="all" />
  <!--// Common Css -->
  <!-- Nav Css -->
  <link rel="stylesheet" href="/resources/css/style4-mp.css">
  <!--// Nav Css -->
  <!-- Fontawesome Css -->
  <link href="/resources/css/fontawesome-all-mp.css" rel="stylesheet">
  <!--// Fontawesome Css -->
  <!--// Style-sheets -->
...
<body>
  ...
  <div class="wrapper">
      ...
      <ul class="list-unstyled components">
        <li>
          ...
          <ul class="collapse list-unstyled" id="homeSubmenu">
            <li>
              <a href="cards.html">· 회원정보 확인</a>
            </li>
            <li>
              <a href="carousels.html">· 개인정보 수정</a>
            </li>
          </ul>
        </li>
        <li class="active">
          ...
          <ul class="collapse list-unstyled" id="list-menu">
            <li>
              <a href="cards.html">· 즐겨찾기 조회 및 관리</a>
            </li>
            <li>
              <a href="carousels.html">· 게시물 등록</a>
            </li>
            <li>
              <a href="cards.html">· 후원한 게임</a>
            </li>
            <li>
              <a href="carousels.html">· 후원받은 게임</a>
            </li>
          </ul>
        </li>
        <li>
    ...
    <div id="content">
      ...
      <!--// top-bar -->
          <!-- Stats -->
          <!-- main-heading -->
          <h2 class="main-title-w3layouts mb-2 text-center">후원</h2>
          <!--// main-heading -->
          <!-- Tables content -->
          <section class="tables-section">
              <!-- table1 -->
              <div class="outer-w3-agile mt-3">
                  <h4 class="tittle-w3-agileits mb-4">후원 받은 컨텐츠</h4>
  ...
  <link href="/resources/css/simplyCountdown-mp.css" rel='stylesheet' type='text/css' />
  <script>
    var d = new Date();
